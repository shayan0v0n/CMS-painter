...
<head>
    ...
    <link rel="stylesheet" href="/public/styles/press.css">
    <link rel="stylesheet" href="/public/lib/animate/index.css">
    <title>Press - Nasir</title>
</head>
<body>
      ...
      <div id="collapse-right">
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="./press">press</a>
                </li>
                <li class="nav-item">
...
<main>
    <div class="mt-5 mb-5 text-center">
        <h2 class="">SELECTION OF ARTICLES</h2>
        <hr class="m-auto w-25">
    </div>
    <div class="row m-0 py-5 text-center">
        <?php if (isset($pressData[0])) { ?>
