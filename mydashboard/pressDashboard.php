...
$pressList = $getDatabase-> getData('press');
...
<div class="m-5">
    <div class="mt-5 mb-3 text-center">
            ...
            <span>Dear <?= $admin[0]['name']?>, You Can Set Your Press Here.</span>
            <hr class="m-auto w-25">
    </div>

    <div>
        <div class="container">
            <form class="m-5 animate__animated animate__fadeInUp" enctype="multipart/form-data" action="../public/server/Actions/add_press_list.php" method="post">
                <div class="my-3">
                    <input type="text" class="form-control" placeholder="Press Title..." id="titleInput" name="pressTitle">
                </div>
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="externalCheckbox" name="isInternal">
                    <label class="form-check-label" for="externalCheckbox">I Want Use External Link</label>
                </div>
                <div class="my-3" id="linkContainer">
                    <div>
                        <input type="text" class="form-control" placeholder="Press Link..." id="linkInput" name="pressLink">
                    </div>
                </div>
                <div class="my-3" id="formFileContainer">
                    <div>
                        <label for="formFile" class="form-label">Enter Your Press File...</label>
                        <input class="form-control" type="file" id="formFile" multiple="true" name="pressFile[]">
                    </div>
                </div>
    ...
    <div>
        <?php if(sizeof($pressList) == 0) {?>
            <div>
                <h2 class="text-center my-5">No Press Yet!</h2>
            </div>
        <?php }else {?>
...
<script src="/public/controller/pressDashboard.js"></script>
</html>