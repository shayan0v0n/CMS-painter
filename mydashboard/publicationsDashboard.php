...
$publicationList = $getDatabase-> getData('publications');
...
<div class="m-5">
    <div class="mt-5 mb-3 text-center">
            <h2>Publications Dashboard</h2>
            <span>Dear <?= $admin[0]['name']?>, You Can Set Your Publications Here.</span>
            <hr class="m-auto w-25">
    </div>

    <div>
        <div class="container">
            <form class="m-5 animate__animated animate__fadeInUp" enctype="multipart/form-data" action="../public/server/Actions/add_publication_list.php" method="post">
                <div class="my-3">
                    <input type="text" class="form-control" placeholder="Publication Name..." id="nameInput" name="publicationName">
                </div>
                <div class="my-3">
                    <div>
                        <input type="text" class="form-control" placeholder="Publication Title..." id="titleInput" name="publicationTitle">
                    </div>
                </div>
                <div class="my-3">
                    <div>
                        <label for="formFile" class="form-label">Enter Your Publication File...</label>
                        <input class="form-control" type="file" id="formFile" multiple="true" name="publicationFile[]">
                    </div>
                </div>
...
<script src="/public/controller/PablicationDashboard.js"></script>
</html>